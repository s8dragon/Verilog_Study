...
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PCLK
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PRESETn
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PADDR
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PSEL
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PENABLE
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PWRITE
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PWDATA
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PREADY
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PRDATA
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PSLVERR
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/IRQ
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/PWM
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/timer_mode
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/timer_go_en
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/timer_tot_cnt
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/timer_duty_cnt
add wave -noupdate -expand -group TIMER_TOP /tb_main/TIMER_TOP/timer_irq_trg
...
update
WaveRestoreZoom {0 ps} {5115088 ps}
